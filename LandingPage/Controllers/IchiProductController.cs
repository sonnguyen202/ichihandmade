...
{
    public class IchiProductController : Controller
    {
        private IProductService _productService;
        private IConfiguration Configuration;
        public IchiProductController(IProductService productService, IConfiguration configuration)
        {
            ...
            foreach (var pc in listProductCategory)
            {
                var exProdCate = new ExhibitProductCategoryViewModel()
                {
                    ...
                    ListExhibitProduct = pc.ListExhibitProduct.Select(p=>new ExhibitProductViewModel() { 
                        ...
                        LinkDetailProduct = Url.Action("Detail", "IchiProduct", new {name = p.ProductName.GetSeoName()+"-"+p.ProductId}),
